...
export class AddCharacterToFavoritesUseCase{
  private characterRepository: CharacterRepository = inject(CharacterImpRepository);

  public async addCharacterToFavorites(character: CharacterEntity): Promise<void>{
    await this.characterRepository.addCharacterToFavorites(character);
  }
}
